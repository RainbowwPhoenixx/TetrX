...
linking_flags = -lncurses -lpthread
...
all_bot_debug_targets = $(object_dir)bot_types_debug.o $(object_dir)tree_debug.o $(object_dir)move_queue_debug.o $(object_dir)bot_debug.o
...
all_bot_targets = $(object_dir)bot_types.o $(object_dir)tree.o $(object_dir)move_queue.o $(object_dir)bot.o
